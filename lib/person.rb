class Person < ActiveRecord::Base
    has_many :poppas, :foreign_key => :parent_id, class_name: "Parent"
    # has_many :poppa_persons, :through => :parents, :source => :person
    has_many :children, :foreign_key => :child_id, class_name: "Parent"
